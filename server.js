...
const QUICK_REPLIES = new Map([
  ...
  ["kya hal hai", "Sab badhiya 😄 Tumhara kya haal hai?"],
  ...
  ["tumhe kisne banaya", "Mujhe mere Malik PRINCE aur ANKUR ne banya h."],
  ["khana khaya", "Main AI hoon, isliye khana nahi khata 😄 Tumne khaya?"],
  ["chai piyoge", "Tum pio gandu prasad."],
  ["so rahe ho", "nhi tumhari bua jawan kr rha hu."],
  ["busy ho", "Nahi, mutthi mar raha hu tumhari yaad me."],
  ["free ho", "Bsdk khud ko dekh le kharid payega fatichar ?"],
  ["bore ho raha hoon", "Chalo kuch interesting karte hain tum palt ke leto mai pichhe se dalta hu"],
  ["mujhe neend aa rahi hai", "To mujhe kya bata raha h dalle  mere sath soye ga kya gand mar lunga "],
  ["mujhe bhookh lagi hai", "bagl wale ka chus  lo 😄"],
  ["mujhe help chahiye", "Bilkul 😊 Batao kis cheez me help chahiye?"],
  ["mujhe samajh nahi aaya", "Koi baat nahi thodi der muh me lelo sb aa jayega."],
